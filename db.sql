...
CREATE TABLE ANNOUNCEMENTS (
    ...
    FOREIGN KEY (POSTED_BY) REFERENCES USERS(IDNO) ON DELETE CASCADE
...
-- PURPOSES table: Stores available purposes for sit-ins
...
CREATE TABLE SIT_IN_RECORDS (
    ...
    SESSION ENUM('ON_GOING', 'ENDED') NULL DEFAULT NULL,
    ...
    FOREIGN KEY (PURPOSE_ID) REFERENCES PURPOSES(PURPOSE_ID) ON DELETE RESTRICT
);
